  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <StatCard label="Materias" value={stats.totalSubjects} accent="text-indigo-600" />
        <StatCard label="Tareas pendientes" value={stats.pendingTasks} accent="text-amber-600" />
        <StatCard label="Tareas hechas" value={stats.doneTasks} accent="text-green-600" />
        <StatCard label="Vencidas" value={stats.overdueTasks} accent="text-red-600" />
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 dark:bg-slate-800 dark:border-slate-700 p-6">
        ...
        {stats.perSubject.length === 0 ? (
          <p className="text-slate-400 text-sm">
            ...
            <Link to="/materias" className="text-indigo-600 hover:underline">
              Creá la primera
            </Link>
            .
          </p>
